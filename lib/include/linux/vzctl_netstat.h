...
#define VZCTL_TC_SET_CLASS_TABLE	_IOW(VZTCCTLTYPE, 3,		\
					struct vzctl_tc_classes)
#define VZCTL_TC_GET_CLASS_TABLE	_IOR(VZTCCTLTYPE, 4,		\
					struct vzctl_tc_classes)

#define VZCTL_TC_STAT_NUM		_IO(VZTCCTLTYPE, 5)
#define VZCTL_TC_GET_STAT_LIST		_IOR(VZTCCTLTYPE, 6,		\
					struct vzctl_tc_get_stat_list)
#define VZCTL_TC_GET_STAT		_IOR(VZTCCTLTYPE, 7,		\
					struct vzctl_tc_get_stat)
...
#define VZCTL_TC_SET_BASE		_IOW(VZTCCTLTYPE, 12,		\
					struct vzctl_tc_set_base)

#define VZCTL_TC_GET_STAT_V6		_IOR(VZTCCTLTYPE, 13,		\
					struct vzctl_tc_get_stat)
#define VZCTL_TC_SET_CLASS_TABLE_V6	_IOW(VZTCCTLTYPE, 14,		\
					struct vzctl_tc_classes_v6)
#define VZCTL_TC_GET_CLASS_TABLE_V6	_IOR(VZTCCTLTYPE, 15,		\
					struct vzctl_tc_classes_v6)
...
#define COMPAT_VZCTL_TC_SET_CLASS_TABLE	_IOW(VZTCCTLTYPE, 3,		\
					struct compat_vzctl_tc_classes)
#define COMPAT_VZCTL_TC_GET_CLASS_TABLE	_IOR(VZTCCTLTYPE, 4,		\
					struct compat_vzctl_tc_classes)
#define COMPAT_VZCTL_TC_GET_STAT_LIST	_IOR(VZTCCTLTYPE, 6,		\
					struct compat_vzctl_tc_get_stat_list)
#define COMPAT_VZCTL_TC_GET_STAT	_IOR(VZTCCTLTYPE, 7,		\
					struct compat_vzctl_tc_get_stat)
#endif
